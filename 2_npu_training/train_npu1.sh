...
nohup python -u train_forward_test.py "train_run" --data_root /home/jiayansuo/Lip2wav_train/Lip2Wav-master_npu_20210602003231/Dataset/chess/ --preset synthesizer/presets/chess.json  > ./train_output_${device_id}.log 2>&1
