...
hparams = HParams(
    ...
    tacotron_batch_size=24, #1 # number of training samples on each training steps
    ...
    eval_ckpt="synthesizer/saved_models/logs-final/taco_pretrained/tacotron_model.ckpt-324000",
